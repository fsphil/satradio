...
int src_read_mono(struct src_t *s, int16_t *dst, int step, int samples)
{
	int i;
...
int src_read_stereo(struct src_t *s, int16_t *dst_l, int step_l, int16_t *dst_r, int step_r, int samples)
{
	int i;
